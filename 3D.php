...
<head>
	...
	<link rel="stylesheet" href="css/3D_style.css"> <!-- Enlace al nuevo CSS -->
</head>
<body>
    ...
    <div class="botones-superiores">
    	...
    	<button class="sistema-btn"><a href="solar_system.php">Sistema Solar</a></button>
    	<button class="personaje-btn"><a href="martial_arts.php">Personaje 3D</a></button>
	</div>
</body>
</html>
